...
<script>
    $(document).ready(function() {
        ...
        $('form').submit(function(event) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('student.attendance')}}", // Replace with your actual Laravel route
                data: formData,
                dataType: 'json',
                success: function(data) {
                    ...
                    $.each(data, function(index, student) {
                        var rowHtml = '<tr>' +
                            '<td style="max-width:5%;"><small>' + student.nama_lengkap + '</small></td>' +
